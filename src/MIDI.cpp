...
{
  // Load from settings
  m_iInDevice = CSettings::GetObject()->Midi.iMidiDevice;
  m_iOutDevice = CSettings::GetObject()->Midi.iMidiOutDevice;

  m_bMasterSync = CSettings::GetObject()->Midi.bMidiMasterSync;
...
{
  // Store settings
  CSettings::GetObject()->Midi.iMidiDevice = m_iInDevice;
  CSettings::GetObject()->Midi.iMidiOutDevice = m_iOutDevice;
